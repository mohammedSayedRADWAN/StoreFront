...
exports.category = exports.deleteProduct = exports.create = exports.show = exports.index = void 0;
...
var deleteProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, info.deleteProduct(req.body.id)];
            case 1:
                deleted = _a.sent();
                if (!deleted) {
                    return [2 /*return*/, res.status(404).json({
...
var category = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, info.getProductBycategory(req.body.category)];
            case 1:
                product = _a.sent();
                if (!product) {
                    return [2 /*return*/, res.status(404).json({
                            status: 'error',
                            message: "can not found product in this ".concat(req.body.category)
                        })];
                }
                return [2 /*return*/, res.json({
                        status: 'success',
